...
entry:
  ...
  %malloccall.23 = tail call i8* @malloc(i32 ptrtoint (%chord_node* getelementptr (%chord_node, %chord_node* null, i32 1) to i32))
  %a224 = bitcast i8* %malloccall.23 to %chord_node*
  ...
  %malloccall.32 = tail call i8* @malloc(i32 ptrtoint (%chord_node* getelementptr (%chord_node, %chord_node* null, i32 1) to i32))
  %a233 = bitcast i8* %malloccall.32 to %chord_node*
